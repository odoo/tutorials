...
class ProductProduct(models.Model):
    ...
    def _get_best_pricing_rule(self, quantity=None, date=None, **kwargs):
        ...
        """
        return self.product_tmpl_id._get_best_pricing_rule(quantity=quantity, date=date, product=self, **kwargs)
    ...
    def _compute_rental_default(self, duration, unit):
        ...
        :rtype: int
        """
        return self.product_tmpl_id._compute_rental_default(duration=duration, unit=unit)
