...
class ResConfigSettings(models.TransientModel):
    ...
    # Import Fields
    l10n_in_import_journal_id = fields.Many2one(related="company_id.l10n_in_import_journal_id", readonly=False)
    l10n_in_import_custom_duty_account_id = fields.Many2one(related="company_id.l10n_in_import_custom_duty_account_id", readonly=False)
    l10n_in_import_default_tax_account_id = fields.Many2one(related="company_id.l10n_in_import_default_tax_account_id", readonly=False)
    l10n_in_import_custom_duty_tax_payable_account_id = fields.Many2one(related="company_id.l10n_in_import_custom_duty_tax_payable_account_id", readonly=False)

    # Export Fields
    l10n_in_export_journal_id = fields.Many2one(related="company_id.l10n_in_export_journal_id", readonly=False)
    l10n_in_export_custom_duty_account_id = fields.Many2one(related="company_id.l10n_in_export_custom_duty_account_id", readonly=False)
    l10n_in_export_default_tax_account_id = fields.Many2one(related="company_id.l10n_in_export_default_tax_account_id", readonly=False)
    l10n_in_export_custom_duty_tax_payable_account_id = fields.Many2one(related="company_id.l10n_in_export_custom_duty_tax_payable_account_id", readonly=False)
