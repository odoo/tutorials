...
class OrderLineWizardLine(models.TransientModel):
    ...
    product_template_id = fields.Many2one(string="Product",comodel_name='product.template',)
    order_line_id = fields.Many2one('sale.order.line', string="Order Line") 
    include_for_division = fields.Boolean("Include orderline for division", default="true")
