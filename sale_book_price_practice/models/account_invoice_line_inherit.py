...
class InheritSaleOrderLine(models.Model):
    ...
    book_price = fields.Float("Book Price", compute="_compute_book_price", default=0.0, store=True)
    ...
    def _compute_book_price(self):
       for line in self:
            ...
            if pricelist:
                line.book_price = pricelist._get_product_price(line.product_id, line.quantity,
                                    line.product_uom_id) if pricelist else 0.0