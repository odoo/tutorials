...
class PropertyOffer(models.Model):
    ...
    @api.depends("property_currency_id")
    def _compute_translated_price(self):
        for offer in self:
            offer.translated_price = offer._compute_currency()

    @api.depends("property_id.currency_id")
    def _compute_property_currency_id(self):
        for offer in self:
            offer.property_currency_id = offer.property_id.currency_id
