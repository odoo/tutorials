...
class EstatePropertyType(models.Model):
    ...
    property_ids = fields.One2many(comode='estate.property', inverse_name='property_type_id')
    offer_ids = fields.One2many(comodel='estate.property.offer', inverse_name='property_type_id')
