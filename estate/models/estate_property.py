...
class EstateProperty(models.Model):
    ...
    date_availability=fields.Date(string='Available date',help='Available date for the property')
    expected_price=fields.Float(string='Expected Price',required=True ,help='Expected Price of the property')
    selling_price = fields.Float(string='Sell Price',required=True, help='Selling price')
