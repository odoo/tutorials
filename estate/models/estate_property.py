...
class EstateProperty(models.Model):
    ...
    property_type = fields.Selection(
        selection=[('office', 'Office'), ('apartment', 'Apartment'), ('house', 'House'), ('studio', 'Studio')],
    ...
    expected_price= fields.Monetary('Expected Price', required = True, currency_field='currency_id')
    selling_price= fields.Monetary('Selling Price', currency_field='currency_id', readonly=True, copy=False)
