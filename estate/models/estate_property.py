...
class EstateProperty(models.Model):
    ...
    salesperson = fields.Many2one('res.users', string="Sales Person", default=lambda self: self.env.user, ondelete="cascade")
    buyer = fields.Many2one('res.partner', string="buyer", copy=False, ondelete="cascade")
    offer_ids = fields.One2many('estate.property.offer', 'property_id', string="Offers")
    tag_ids = fields.Many2many("estate.property.tag", string="Tags ID", ondelete="cascade")
