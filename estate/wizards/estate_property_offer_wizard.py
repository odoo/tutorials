...
class EstatePropetyOfferWizard(models.TransientModel):
    ...
    date_deadline = fields.Date(
        "Deadline", default=lambda self: fields.Date.today() + timedelta(days=7)
    )
    ...
    def action_add_offer(self):
        ...
        for estate_property in properties:
            if estate_property.state == 'sold':
                ...
                raise UserError(f"The property '{estate_property.name}' has an offer accepted")
