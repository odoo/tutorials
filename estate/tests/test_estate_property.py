...
class EstateTestCase(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.accepted_offer.action_accept()  # Changed to match your model's method name
    ...
    def test_action_sell(self):
        ...
        self.property_with_accepted_offer.property_sold()
    ...
    def test_action_create_offer_for_sold_property(self):
        ...
        self.property_new.property_sold()
        with self.assertRaises(UserError, msg="Should not be able to create offer for sold property"):
    ...
    def test_sell_property_correctly_marked_sold(self):
        ...
        self.property_with_accepted_offer.property_sold()  # Changed to match your model's method name
        self.assertEqual(self.property_with_accepted_offer.status, 'sold',
                         "Property status should be 'sold' after selling")
    ...
    def test_best_offer_calculation(self):
        """Test that best offer is correctly calculated from offers."""
        self.env['estate.property.offer'].create({
        ...
        self.assertEqual(float(self.property.best_offer), 105000.0, "Best offer should be the highest offer")  # Changed to best_offer and handling as float
