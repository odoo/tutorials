...
class EstateTestCase(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.accepted_offer.action_accept_offer()
    ...
    def test_action_sell(self):
        ...
        self.property_with_accepted_offer.action_property_sold()
    ...
    def test_action_sell_cancelled_property(self):
        ...
        self.property_with_accepted_offer.action_property_cancel()
    ...
    def test_action_create_offer_for_sold_property(self):
        """Test that action_accept_offer fails on a sold property."""
        self.new_offer.action_accept_offer()
