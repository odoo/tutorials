...
class BillEntryDetails(models.TransientModel):
    _name = 'bill.entry.details'
    _description = 'Bill Entry Details'
    ...
    custom_duty = fields.Monetary(
        string='Custom Duty & Additional Charges', currency_field='currency_id', default=0.0,
    )
