...
class MrpProduction(models.Model):
    ...
    x = fields.Boolean(string="x field")

    @api.depends('procurement_group_id.sale_id.order_line.product_uom', 'procurement_group_id.mrp_production_ids.s_unit')
    def _compute_s_unit(self):
        for record in self:
            ...
            print(f"Source MO: {source_mo}, Sale Order: {sale_order}")
