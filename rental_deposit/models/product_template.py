...
class ProductTemplate(models.Model):
    ...
    require_deposit = fields.Boolean(
        ...
        help="Check this box if this rental product requires a deposit"
    )
    deposit_amount = fields.Float(
        string='Deposit Amount',
        help="Amount to be deposited per unit of this product"
    )
    deposit_total = fields.Float(compute="_compute_deposit_total")

    @api.constrains('require_deposit', 'deposit_amount')
