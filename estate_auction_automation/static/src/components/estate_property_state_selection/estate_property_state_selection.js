...
export class EstatePropertyStateSelection extends StateSelectionField {
    static template = "estate_auction_automation.EstatePropertyStateSelection";
...
export const estatePropertyStateSelection = {
    ...stateSelectionField,
    component: EstatePropertyStateSelection,
    supportedOptions: [
...
registry.category("fields").add("estate_property_state_selection", estatePropertyStateSelection);
