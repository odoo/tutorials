...
registry.category("web_tour.tours").add("sign_template_stamp_creation_tour", {
    url: "/odoo",
    steps: () => [
        {
        ...
        {
            trigger: ":iframe .o_sign_field_type_button:contains(" + _t("Stamp") + ")",
            content: markup(_t("<b>Drag & drop Stamp</b> into the bottom of the document.")),
