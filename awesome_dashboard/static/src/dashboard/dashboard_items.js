...
dashboardRegistry.add("average_quantity", {
    ...
    size: 1,
    props: (data) => ({
        label: _t("Average amount of T-Shirts by this month"),
...
dashboardRegistry.add("average_time", {
    ...
    size: 2,
    props: (data) => ({
        label: _t("Average time for an order to go from 'new' to 'sent' or 'cancelled'"),
...
dashboardRegistry.add("nb_new_orders", {
    ...
    size: 1,
    props: (data) => ({
        label: _t("Number of new orders this month"),
