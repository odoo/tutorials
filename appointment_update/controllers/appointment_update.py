...
class AppointmentUpdateController(AppointmentController):
    ...
    def appointment_form_submit(self, appointment_type_id, datetime_str, duration_str, name, phone, email, staff_user_id=None, available_resource_ids=None, asked_capacity=1,
        ...
        # my code changes
            ...
            if staff_user and (appointment_type.track_capacity != 'one_booking_per_slot' and users_remaining_capacity['total_remaining_capacity'] < asked_capacity):
        ...
        else: # my code changes
            user_remaining_capacity = users_remaining_capacity['total_remaining_capacity']
            new_capacity_reserved = min(user_remaining_capacity, asked_capacity, appointment_type.total_booking)
            booking_line_values.append({
