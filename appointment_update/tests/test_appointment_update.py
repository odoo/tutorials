...
class TestAppointmentCapacity(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        appointments = cls.env['appointment.type'].create([{
            ...
            'max_schedule_days': 8,
            'name': 'Managed Test',
            'track_capacity': 'multiple_seat_per_slot',
        ...
        resources = cls.env['appointment.resource'].create([
            {
                'appointment_type_ids': [(6, 0, [cls.appointment_manage_capacity.id])],
                'capacity': 3,
                'name': 'Resource 1',
            },
            {
            ...
            {
                'appointment_type_ids': [(6, 0, [cls.appointment_manage_capacity.id, cls.appointment_regular.id])],
                'capacity': 1,
                'name': 'Resource 3',
            }
        ])
        ...
        cls.reference_monday = datetime(2025, 3, 29)  # Example: March 17, 2025 (Monday)
