...
class AppointmentControllerExtends(AppointmentController):
    ...
    def _prepare_appointment_type_page_values(self,appointment_type,staff_user_id=False,resource_selected_id=False,**kwargs):
        ...
        #update max_capacity_possible logic
    ...
    def appointment_form_submit(self, appointment_type_id, datetime_str, duration_str, name, phone, email, staff_user_id=None, available_resource_ids=None, asked_capacity=1,
        ...
        if appointment_type.schedule_based_on == 'resources':
            ...
            for resource in resources:
                ...
                if appointment_type.capacity_type == "one_booking":
                    capacity_used = resource.capacity
                elif resource.shareable:
            ...
            user_remaining_capacity = appointment_type._get_user_remaining_capacity(staff_user, date_start, date_end)
            new_capacity_reserved = min(user_remaining_capacity, asked_capacity)
